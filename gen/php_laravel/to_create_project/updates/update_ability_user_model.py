...
def update_ability_user_model(full_path):    
    """
    Genera el archivo
    """
    main_jsx_path = os.path.join(full_path, "app", "Models", "API", "AbilityUsers", "AbilityUser.php")
    ...
    try:
        ...
        content = content.replace(
            r"""protected $table = 'ability_users';""",
            r"""protected $table = 'ability_user';"""
        )
